...
import { typeOfTransactionOptions, orderTypeOptions, closurePositionOptions, typeOrderOptions } from './Options';
    ...
    useEffect(() => {
        const recuperationUnTradebrut = async (id, collection) => {
            try {
                ...
                setTypeOrder(response[0].typeOrdre);
    ...
    const correctionTrade = async () => {
        try {
            ...
            const correctionTradeStatus = await correctionTradeSeul(
                ...
                stopLoss, takeProfit, priceClosure, swap, profit, commission, balance, typeTransaction, orderType, identifier, closurePosition, ticketNumber, typeOrder
            );
                ...
                <div className="cadreModifierTrade">
                    <div className="contenuMontreModifierTrade">
                        <div className="infoModifierTrade">
                            ...
                            <div className="ITmodification"><p>Type order</p><Selector options={typeOrderOptions} value={typeOrder} onChange={(selected) => {setTypeOrder(selected);}} /></div>
