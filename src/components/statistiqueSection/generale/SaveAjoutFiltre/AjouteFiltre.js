...
const AjouteFiltre = () => {
    ...
    useEffect(() => {
        ...
        fetchFiltreData();
    }, [symboleValue, typeTransactionValue, startDateValue, endDateValue, volumeValue, volumeRemainValue, profitValue, collectionValues, psychologieValue, tableauFiltreValue]);
                ...
                <div className="filtreConteneur">
                    ...
                    <div className='collectionOptions'>
                        ...
                        <div className='standardOptions'>
                            <p>Standard</p>
                            <Selector options={standardOptions} value={standardValue} onChange={(selectedValue) => {verificationStandardOption(
